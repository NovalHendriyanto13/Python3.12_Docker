...
async def extract_and_load():
    ...
    async for doc in cursor:
        row=(
            ...
            to_int(doc.get("rewardtype")),
            to_int(doc.get("offerid")),
            to_int(doc.get("expiresafterndays")),
            to_bool(doc.get("isexpirytimespecified")),
            to_int(doc.get("expirytimeafteractivation")),
            to_int(doc.get("pointvalue")),
            to_int(doc.get("activationlimit")),
            to_int(doc.get("activationweight")),
            to_int(doc.get("activationremained")),
            doc.get("market")
        )
        batch.append(row)
