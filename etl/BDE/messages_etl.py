...
async def extract_and_load():
    ...
    async for doc in cursor:
        row=(
            ...
            doc.get("name"),
            to_int(doc.get("channeltype")),
            to_int(doc.get("campaignid")),
            doc.get("subject"),
            doc.get("body"),
            doc.get("emailtextbody"),
            to_int(doc.get("offerid")),
            to_int(doc.get("recurringtypecode")),
            to_int(doc.get("dailystarttime")),
            to_int(doc.get("dailyendtime")),
            to_int(doc.get("timeframetype")),
            to_datetime(doc.get("datemodified")),
            to_datetime(doc.get("datecreated")),
            to_datetime(doc.get("timeframestartdate")),
            to_datetime(doc.get("timeframeenddate"))
        )
        batch.append(row)
