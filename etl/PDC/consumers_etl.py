...
async def extract_and_load_consumers_fast():
    ...
    async for doc in cursor:
        row = (
            ...
            doc.get("last_known_device_id"),
            doc.get("market"),
            doc.get("first_name"),
            doc.get("last_name"),
            doc.get("full_name"),
            doc.get("email_address"),
            doc.get("gender"),
            to_datetime(doc.get("date_of_birth")),
            doc.get("phone_number"),
            doc.get("postcode"),
            to_bool(doc.get("is_deactivated")),
            to_int(doc.get("registration_type")),
            to_int(doc.get("consumer_type")),
            doc.get("registration_source"),
            to_datetime(doc.get("creation_date")),
            to_datetime(doc.get("modified_date")),
            to_datetime(doc.get("deactivation_date"))
        )
        batch.append(row)
