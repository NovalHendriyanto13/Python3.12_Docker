...
class OfferActivities(Base):
    ...
    click_through_count = Column(Integer)
    redemption_count = Column(Integer)
    in_store_redemption_count = Column(Integer)
    rewards_activated_count = Column(Integer)
    offer_bag_add_offer_count = Column(Integer)
    offer_bag_remove_offer_count = Column(Integer)
